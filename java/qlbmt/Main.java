...
public class Main {
  public static void main(String[] args) {
    ...
    DisplaySalesHistory displaySalesHistory = new DisplaySalesHistory(); // Chức năng mới
    ...
    while (choice != 0) {
      ...
      System.out.println("7. Xem lịch sử bán hàng");
      ...
      try {
        ...
        switch (choice) {
          ...
          case 6:
            ...
            break;
          case 7:
            displaySalesHistory.execute(store);
            break;
          case 0:
